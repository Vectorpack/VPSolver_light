...
private:
	...
	void init(const Instance &_inst, const bool verbose = false);

	void init(const char *fname, const bool verbose = false);
...
public:
	...
	explicit Arcflow(const Instance &_inst, const bool verbose);

	explicit Arcflow(const char *fname, const bool verbose);
